...
This immediately means that for every eigenvector $\vec{v} = [\vec{v}_1, \vec{v}_2]$ with eigenvalue $\epsilon$, there is a corresponding pair $\vec{v}' = [\vec{v}_2^*, \vec{v}_1^*]$ with eigenvalue $-\epsilon$. This is interpreted as a particle-hole symmetry in the Bogoliubov spectrum. In case of fermions where $\Sigma = I_{2N}$, this symmetry is already present in the original Hamiltonian, $H_{BdG}$.
